...
public class SearchBook extends JPanel {
	...
	public SearchBook(UserFrame frame, boolean manager) {
		...
		if (authors.length > 0 && publishers.length > 0 && categories.length > 0) {

			checks = 0;

			JPanel authorPanel = new JPanel();
			authorPanel.setBorder(new TitledBorder(new LineBorder(new Color(255, 0, 0), 1, true), "Search Book",
			...
			publisherPanel.setBorder(new TitledBorder(new LineBorder(new Color(255, 0, 0)), "Publisher",
					TitledBorder.LEADING, TitledBorder.TOP, null, Color.BLUE));
			...
			try {
				pubbImg = ImageIO
						.read(new File("images\\Building_business_real_house_mall_store_company_state-128.png"));
			} catch (IOException e) {
				e.printStackTrace();
			}
			...
			catPanel.setBorder(new TitledBorder(new LineBorder(new Color(255, 0, 0), 1, true), "Category",
					TitledBorder.LEADING, TitledBorder.TOP, null, Color.BLUE));
			...
			otherPanel.setBorder(new TitledBorder(new LineBorder(new Color(255, 0, 0), 1, true), "Other",
					TitledBorder.LEADING, TitledBorder.TOP, null, Color.BLUE));
			...
			JOptionPane.showMessageDialog(null, "You must enter a book first !", "Error", JOptionPane.ERROR_MESSAGE);
			cntPane.removeAll();
			cntPane.revalidate();
			cntPane.repaint();
		}
