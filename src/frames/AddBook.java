	...
	public AddBook(UserFrame frame) {
		...
		if (categories != null && categories.length > 0) {
			...
			if (publishers != null && publishers.length > 0) {
				panel.setBorder(new TitledBorder(new LineBorder(new Color(255, 0, 0), 1, true), "Add Book",
				...
				btnAdd.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						String[] attributes = { ISBNText.getText(), titleText.getText(),
								(String) pubList.getSelectedItem(), yearText.getText(), priceText.getText(),
								(String) catList.getSelectedItem(), copiesText.getText(), thresholdText.getText() };
						if (ISBNText.getText().equals("") || titleText.getText().equals("")
							...
							JOptionPane.showMessageDialog(null, "please complete required data ", "Warning",
							...
							if (response.isCorrect()) {
								...
								cntPane.revalidate();
								cntPane.repaint();
								JOptionPane.showMessageDialog(null, "Operation completed successfully", "INFO",
										JOptionPane.INFORMATION_MESSAGE);
							} else {
								JOptionPane.showMessageDialog(null, response.getMessage(), "Warning",
										JOptionPane.WARNING_MESSAGE);
							}
						}
					}
				...
				JOptionPane.showMessageDialog(null, "You must enter a publisher first !", "Error",
			...
			JOptionPane.showMessageDialog(null, "You must enter a category first !", "Error",
					JOptionPane.ERROR_MESSAGE);
		}
	}
}
